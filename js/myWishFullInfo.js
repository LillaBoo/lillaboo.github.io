$(document).ready(function(){
	...
	$(document).on('click', '#toWishGift2', function(){
		$.ajax({
			...
			$('#toWishGift2').css('display', 'none');
			$('#toNotWishGift2').css('display', 'inline-block');
		});
	});

	$(document).on('click', '#toNotWishGift2', function(){
		$.ajax({
			...
			$('#toNotWishGift2').css('display', 'none');
			$('#toWishGift2').css('display', 'inline-block');
		});
	});
